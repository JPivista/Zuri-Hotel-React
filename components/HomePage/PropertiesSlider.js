                        ...
                        <Col className='d-flex flex-row p-3'>
                            ...
                            <Col className='d-flex flex-column align-items-center justify-content-center'>
                                <Link href="/lake-resorts-in-kumarakom/"
                                    className='d-inline-block bg-black  text-decoration-none text-white rounded-circle p-3'
                                >
                                    <p
                                        className='mb-0 text-white lh-1 d-flex flex-column align-items-center justify-content-center' style={viewCircle}>
                                        VIEW
                                        <br />
                                        More
                                    </p>
                        ...
                        <Col className='d-flex flex-row p-3'>
                            ...
                            <Col className='d-flex flex-column align-items-center justify-content-center'>
                                <Link href="/beach-resorts-in-goa/"
                                    className='d-inline-block bg-black  text-decoration-none text-white rounded-circle p-3'
                                >
                                    <p className='mb-0 text-white lh-1 d-flex flex-column align-items-center justify-content-center' style={viewCircle}>
                                        VIEW
                                        <br />
                                        More
                                    </p>
                    ...
                    <Col className='d-flex flex-column border border-2 border-light-subtle p-0 m-2'>
                        ...
                        <Col className='d-flex flex-row p-3'>
                            ...
                            <Col className='d-flex flex-column align-items-center justify-content-center'>
                                ...
                                >
                                    <p
                                        className='mb-0 text-white lh-1 d-flex flex-column align-items-center justify-content-center'
                                        style={viewCircle}
                                    >
                                        VIEW
                                        <br />
