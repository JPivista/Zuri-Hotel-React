                ...
                >
                    <Col className='border border-1 shadow-sm p-0'>
                        ...
                        <Col className='d-flex justify-md-content-center justify-content-end align-items-md-start p-0 pe-2 pb-2'>
                            <Link href="" className='bg-black p-0 text-center rounded-circle text-decoration-none '>
                                <p className='p-0 m-0 lh-sm text-white btn-circle' style={{ fontSize: '11px' }}>
                                    VIEW<br /> OFFER
                                </p>
                            </Link>
                        </Col>
                    ...
                    <Col className='border border-1 shadow-sm p-0'>
                        ...
                        <Col className='p-2 pb-0'>
                            <h6 className='text-black'>WELLNESS
                                <br />
                                PACKAGES</h6>
                            <p>
                        ...
                        <Col className='d-flex justify-md-content-center justify-content-end align-items-md-start p-0 pe-2 pb-2'>
                            <Link href="" className='bg-black p-2 text-center rounded-circle text-decoration-none '>
                                <p className='p-2 m-0 lh-sm text-white btn-circle' style={{ fontSize: '11px' }}>
                                    VIEW<br /> OFFER
                                </p>
                            </Link>
                        </Col>
                    ...
                    <Col className='border border-1 shadow-sm p-0'>
                        ...
                        <Col className='d-flex justify-md-content-center justify-content-end align-items-md-start p-0 pe-2 pb-2'>
                            <Link href="" className='bg-black p-2 text-center rounded-circle text-decoration-none '>
                                <p className='p-2 m-0 lh-sm text-white btn-circle' style={{ fontSize: '11px' }}>VIEW<br /> OFFER</p>
                            </Link>
                        </Col>
                    </Col>
                        ...
                        <Col className='d-flex flex-column gap-3'>
                            <Col className='d-flex flex-row border border-1 shadow-sm'>
                                ...
                                <Col className='d-flex justify-content-center align-items-md-start position-absolute vobtn'>
                                    <Link href="" className='bg-black p-1 text-center rounded-circle text-decoration-none float-end'>
                                        <p className=' m-0 lh-sm text-white btn-circle' style={{ fontSize: '11px' }}>VIEW<br /> OFFER</p>
                                    </Link>
                                </Col>
                                <Col>
                                    <Image src='/home/wellness_package.jpg' alt='' width="100%" />
