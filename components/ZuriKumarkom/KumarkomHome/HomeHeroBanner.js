...
const HomeHeroBanner = () => {
    return (
        <>
            <Container className='p-0 pt-md-5 custom-kumarkom-menu-container'>

                <h3 className='text-center py-md-4 text-custom-grey'>THE ZURI KUMARAKOM, KERALA RESORT & SPA</h3>
                ...
                <Col>
                    ...
                    <Col className='d-flex flex-row align-items-center'>
                        ...
                        <Link href=""
                            ...
                            <h6 className='text-custom-megenta banner-breadcrumbs m-0'>Lake Resorts In Kumarakom</h6>
                        </Link>
                    </Col>
                </Col>
            </Container>
